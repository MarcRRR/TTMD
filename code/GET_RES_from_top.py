def GET_RES_from_top(top_name):
	...
	print ( ' ... Number of TOTAL atoms      : {:6d} \n'.format(num_atoms_SYS ) )
	print ( ' ... Number of TOTAL residues   : {:6d} \n'.format(num_res_SYS   ) )
	...
	print( ' ... Number of PROTEIN residues : {:6d} \n'.format(num_res_prot ) )
	print( ' ... Number of LIGAND  residues : {:6d} \n'.format(num_res_LIG  ) )
	print( ' ... Number of IONS    residues : {:6d} \n'.format(num_res_ION  ) )
	print( ' ... Number of SOLVENT residues : {:6d} \n'.format(num_res_SOL  ) )
	if num_res_MEM != 0 :
		print( ' ... Number of MEMBRANE residues : {:6d} \n'.format(num_res_MEM   ) )
	if num_res_COFAC != 0 :
		print( ' ... Number of COFACTS residues : {:6d} \n'.format(num_res_COFAC ) )
	if num_res_IonsCOFAC != 0 :
		print( ' ... Number of IonsCOF residues : {:6d} \n'.format(num_res_IonsCOFAC ) )
	print( ' ... LIGAND residue name        : {:>6} \n'.format(name_res_LIG ) )
	print( ' ... LIGAND Positions           : \n' )
	print( ' ...  {:>6} \n'.format(pos_LIG_line   ) )
	print( ' ...  {:>6} \n'.format(pos_LIG_LNoWat ) )
